...
transform_lambda_test = Lambda_script('script/test/test_lambda_function.py', 'transform.zip', "test-function-transform")
transform_lambda_test.master()
load_lambda_test = Lambda_script('script/test/test_lambda_function.py', 'load.zip', "test-function-load")
load_lambda_test.master2()
